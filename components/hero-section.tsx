          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  The all-in-one platform for intelligent task management.
                  Merge, prioritize, and execute with the help of advanced AI
                ...
                >
                  ...
                  >
                    <Link href="/tasks">
                      <span className="text-nowrap">Try AI Assistant</span>
                    </Link>
                  </Button>
                </AnimatedGroup>
              </div>
