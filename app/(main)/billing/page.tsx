...
const plans = [
  {
    ...
    features: ['10 AI messages per day', 'Unlimited tasks', 'Basic context fusion', 'Community support'],
    isCurrent: true,
    available: true,
  },
  {
    ...
    features: ['Unlimited AI messages', 'Advanced context fusion', 'Priority agent response', 'Multi-device sync'],
    isCurrent: false,
    available: false,
  },
  {
    ...
    features: ['Custom AI models', 'Dedicated success manager', 'SSO & Advanced security', 'Early access to features'],
    isCurrent: false,
    available: false,
  },
];
            ...
            <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground max-w-sm">
                  We are working on bringing more powerful features and higher limits soon. 
                  Stay tuned for our upcoming Pro and Enterprise releases!
                </p>
              </div>
            </CardContent>
          </Card>
